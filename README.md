...
Transformação em um projeto winforms usando os arquivos do treinamento como base. Separei o projeto em camadas para compartilhar as regras entre os dois projeto: Console e winforms
